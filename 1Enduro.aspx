<%@ Page Language="C#" AutoEventWireup="true" CodeFile="1Enduro.aspx.cs" Inherits="cataloghi_EnduroBike" %>
                                            ...
                                            <div class="row marginii">
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                    <div class="carousel-sporrt_text ">
                                                        ...
                                                        <asp:Button class="boynow_bt" ID="btnEnduroPark" runat="server" Text="Parco Enduro" OnClick="btnEnduroPark_Click" />
                                                ...
                                                <div class="row marginii">
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                        <div class="carousel-sporrt_text ">
                                                            ...
                                                            <p class="lorem_text">In collaborazioen con Decathlon</p>
                                                            <asp:Button class="boynow_bt" ID="btnMountainPark" runat="server" Text="Parco MountainBike" OnClick="btnMountainPark_Click" />
                                                            <button class="contact_bt">Contact Us</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="row marginii">
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                    <div class="carousel-sporrt_text ">
                                                        ...
                                                        <p class="lorem_text">In collaborazioen con Decathlon</p>
                                                        <asp:Button class="boynow_bt" ID="btnRacePark" runat="server" Text="Parco Corsa" OnClick="btnRacePark_Click" />
                                                        <button class="contact_bt">Contact Us</button>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
