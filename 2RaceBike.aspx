<%@ Page Language="C#" AutoEventWireup="true" CodeFile="2RaceBike.aspx.cs" Inherits="RaceBike" %>
                            ...
                            <div class="togle_3">
                                ...
                                <div class="middle_main">
                                    <div class="shoping_bag">
                                        <img src="images/shopping-bag.png"></div>
                                </div>
                                <div class="right_main">
                                    <div class="togle_main"><a class="class=openbtn" onclick="openNav()">
                                        <img src="images/togle-menu-icon.png" style="max-width: 100%;"></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="row marginii">
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                    <div class="carousel-sporrt_text ">
                                                        <h1 class="sport_text"><strong>Sports<br>
                                                            <span style="color: #fff;">Cycle</span></strong></h1>
                                                        <p class="lorem_text">Il nostro parco enduro è davvero uno dei migliori con alcuni dei modelli best-seller di tutta la francia </p>
                                                        <p class="lorem_text">In collaborazioen con Decathlon</p>
                                                        <asp:Button class="boynow_bt" ID="btnEnduroPark" runat="server" Text="Esplora Parco Enduro" OnClick="btnEnduroPark_Click" />
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                    <div class="img-box">
                                                        <figure>
                                                            <img src="images/img-1.png" style="max-width: 100%;" /></figure>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row marginii">
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                        <div class="carousel-sporrt_text ">
                                                            <h1 class="sport_text"><strong>Sports<br>
                                                                <span style="color: #fff;">Cycle</span></strong></h1>
                                                            <p class="lorem_text">Il nostro parco Mountain Bike è davvero uno dei migliori con alcuni dei modelli best-seller di tutta la francia</p>
                                                            <p class="lorem_text">In collaborazioen con Decathlon</p>
                                                            <asp:Button class="boynow_bt" ID="btnMountainPark" runat="server" Text="Esplora Parco Mountain Bike" OnClick="btnMountainPark_Click" />
                                                            <button class="contact_bt">Contact Us</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="row marginii">
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                    <div class="carousel-sporrt_text ">
                                                        <h1 class="sport_text"><strong>Sports<br>
                                                            <span style="color: #fff;">Cycle</span></strong></h1>
                                                        <p class="lorem_text">>Il nostro parco Race Bike è davvero uno dei migliori con alcuni dei modelli best-seller di tutta la francia</p>
                                                        <p class="lorem_text">In collaborazioen con Decathlon</p>
                                                        <asp:Button class="boynow_bt" ID="btnRacePark" runat="server" Text="Esplora Parco Race" OnClick="btnRacePark_Click" />
